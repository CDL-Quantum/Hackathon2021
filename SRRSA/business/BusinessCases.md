...
* The global aviation weather forecasting services market is projected to reach US$ 447.6 million in 2024 [10].
...
**Products:**  Our first product, CloudQ targets the attractive aviation weather forecast market. It also provides a storm detection feature. It surves as a basis for our SolarPowerQ product which predicts solar electricity generation less than a few hours in advance. To get solar forecasts SolarPowerQ precisely locates where each cloud will be relative to a solar array, and how the size and shape of the clouds influence how much sunlight gets through to the solar panels. By maximizing the solar panel output, fossil fuel power stations are run less, and by doing so we reduce CO2 emissions and their impact on climate change [12]. Eventhough this product does not directly relate to weather forecast energy utility clients love it as they contribute to climate change mitigation. Our next product PrecipitationQ is more challenging to forecast than temperature due to the discontinuous nature of the phenomena [13]. Our goal is to bundle the diffrent data points we collect from clouds, wildfires etc. and extend the medium-term weather forecast feature from (4–9 days) to 5-10 forecast period with WeatherQ+ product.

The weather forecast platform can be transformed/generalized into image processing platform covering various verticals such as weather forecasting, emotion recognition to name a few. Image processing systems market is expected to reach USD 26 billion by 2027 growing at a growth rate of 21.8% [14]. The extensibility is given by due to the similarity of the problem as they belong to multi-class classification problems. They all can be modeled using recurrent neural networks due to their temporal interactions.
...
[4] [How Weather Forecasts Are Made](https://www.discovermagazine.com/planet-earth/how-weather-forecasts-are-made). Accessed July 26, 2021.

[5] [Zhang, J. et al.. 2021. Support Vector Machine Weather Prediction Technology Based on the Improved Quantum Optimization Algorithm](https://www.hindawi.com/journals/cin/2021/6653659/)

[6] [Billion-Dollar Weather and Climate Disasters: Overview | National Centers for Environmental Information (NCEI)](https://www.ncdc.noaa.gov/billions/). Accessed July 26, 2021 

[7] [How Does Weather Forecasting Work?](https://www.scienceabc.com/innovation/how-does-weather-forecasting-work.html#how-does-weather-forecasting-work). Accessed July 26, 2021

[8] [Machine Learning Improves Weather and Climate Models](https://eos.org/research-spotlights/machine-learning-improves-weather-and-climate-models). Accessed July 27, 2021

[9] [Kashyap, P. et al. 2020. Intelligent Weather Forecasting using Machine Learning Techniques](https://www.irjet.net/archives/V7/i3/IRJET-V7I3499.pdf)

[10] [Aviation Weather Forecast Market](https://www.stratviewresearch.com/367/Aviation-Weather-Forecasting-Services-Market.html). Accessed July 26, 2021

[11] [Weather Forecast Systems Market](https://www.marketsandmarkets.com/Market-Reports/meteorological-weather-forecasting-systems-market-29645152.html).  Accessed July 26, 2021

[12] [Faulty Weather Forecasts Are a Climate Crisis Disaster](https://www.wired.com/story/bad-weather-forecasts-climate-crisis-disaster/ ). Accessed July 26, 2021

[13] [How Weather Forecasts Are Made](https://www.discovermagazine.com/planet-earth/how-weather-forecasts-are-made). Accessed July 26, 2021

[14] [Global Image Processing Systems Market](https://www.databridgemarketresearch.com/reports/global-image-processing-systems-market). Accessed July 28, 2021
