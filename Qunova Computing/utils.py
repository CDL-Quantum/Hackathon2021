...
def LoadData(TestSize, NumPCs):
	cov_related_genes=['ACE2','AGTR1','NFKB1','RELA','IL12A','CCL2','ISG15','IFIH1','TBK1','C2','C3','C5','C1R','C1S','FGA', 'FGB','FGG','RPS2','RPS3',
						'RPS3A','RPS4X','RPS4Y1','RPS5','RPS6','RPS7','RPS8','RPS9','RPS11','RPS12','RPS13','RPS14','RPS15','RPS15A','RPS16','RPS18','RPS19',
						'RPS20','RPS21','RPS23','RPS24','RPS25','RPS26','RPS27','RPS27A','RPS28','RPS29','FAU','RPSA','IRF3','STAT1','STAT2']

	# Data Preprocessing
	df = pd.read_csv('./GSE147507_Series6,16.csv', index_col=0)
	not_related_genes_ = [x for x in df.index if x not in cov_related_genes]
	not_related_genes = random.sample([x for x in not_related_genes_ if 0 not in list(df.loc[x, :])], len(cov_related_genes))
